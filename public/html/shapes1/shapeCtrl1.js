// function myFunction() {
 ...
 $(document).ready(function() {
  ...
  var app = {
    cards: ['./img/Shape8-256.png','./img/Shape8-256.png','./img/Celtic knot 03-256.png','./img/Celtic knot 03-256.png'],
    init: function() {
      app.shuffle();
    },
    shuffle: function() {
