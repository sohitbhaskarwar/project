 ...
 $(document).ready(function() {
  ...
  var app = {
    cards: ['./img/Celtic knot 03-256.png','./img/Celtic knot 03-256.png','./img/Shape8-256.png','./img/Shape8-256.png','./img/Shape-Star2-256.png','./img/Shape-Star2-256.png','./img/Shape9-256.png','./img/Shape9-256.png'],
    init: function() {
      app.shuffle();
    },
    shuffle: function() {
