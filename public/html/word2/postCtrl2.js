...
var obj=[];
var a,b,wor,col;
var words=["RED","BLACK","GREEN","ORANGE"];
var colors=["RED","BLACK","GREEN","ORANGE"];
...
function countDown()
{
   ...
   document.getElementById("tab").style.display="none";
    ...
    document.getElementById("msg").innerHTML="LEVEL 2";
    var z=0;
...
function perform()
{
	var colors1=["RED","BLACK","GREEN","ORANGE"];
	var rate=["s1","s2","s3","s4"];
...
function result()
{
	...
	var colors2=["RED","BLACK","GREEN","ORANGE"];
	var ans=[];
	var count=0;
	var rate=["s1","s2","s3","s4"];
