var rwords=[];
		...
		var obj=[];
		var a,b,wor,col;
		var words=["RED","BLACK","GREEN","CYAN","PURPLE","YELLOW","BROWN","ORANGE","BLUE","PINK"];
		var colors=["RED","BLACK","GREEN","CYAN","PURPLE","YELLOW","BROWN","ORANGE","BLUE","PINK"];
setTimeout(move,0);
function move() {
...
function countDown(){
   ...
   document.getElementById("div2").style.display="none";
    ...
    document.getElementById("msg").innerHTML="LEVEL 8";
    var z=0;
...
function perform(){
	var colors1=["RED","BLACK","GREEN","CYAN","PURPLE","YELLOW","BROWN","ORANGE","BLUE","PINK"];
	var rate=["s1","s2","s3","s4","s5","s6","s7","s8","s9","s10"];
...
function result(){
	...
	var colors2=["RED","BLACK","GREEN","CYAN","PURPLE","YELLOW","BROWN","ORANGE","BLUE","PINK"];
	var ans=[];
	var count=0;
	var rate=["s1","s2","s3","s4","s5","s6","s7","s8","s9","s10"];
