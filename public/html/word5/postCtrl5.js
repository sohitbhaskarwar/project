var rwords=[];
		...
		var obj=[];
		var a,b,wor,col;
		var words=["RED","BLACK","GREEN","YELLOW","BROWN","ORANGE","BLUE"];
		var colors=["RED","BLACK","GREEN","YELLOW","BROWN","ORANGE","BLUE"];
setTimeout(move,0);
function move() {
...
function countDown(){
   ...
   document.getElementById("div2").style.display="none";
    ...
    document.getElementById("msg").innerHTML="LEVEL 5";
    var z=0;
...
function perform(){
	var colors1=["RED","BLACK","GREEN","YELLOW","BROWN","ORANGE","BLUE"];
	var rate=["s1","s2","s3","s4","s5","s6","s7"];
...
function result(){
	...
	var colors2=["RED","BLACK","GREEN","YELLOW","BROWN","ORANGE","BLUE"];
	var ans=[];
	var count=0;
	var rate=["s1","s2","s3","s4","s5","s6","s7"];
